...
node "$ROOT_DIR/.agents/skills/katei-auth-debug/scripts/open-authenticated-page.mjs" --config "$CONFIG_PATH"
node "$ROOT_DIR/.agents/skills/katei-auth-debug/scripts/capture-auth-debug-artifacts.mjs" --config "$CONFIG_PATH"
