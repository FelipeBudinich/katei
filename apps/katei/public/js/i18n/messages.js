const EN_MESSAGES = freezeCatalog({
  ...
  boardEditor: {
    ...
    stagesLabel: 'Stages',
    stagesHelp: 'One line per stage: stage-id | Display title | target-a, target-b',
...
const ES_CL_MESSAGES = freezeCatalog({
  ...
  boardEditor: {
    ...
    stagesLabel: 'Etapas',
    stagesHelp: 'Una línea por etapa: stage-id | Título visible | destino-a, destino-b',
...
const JA_MESSAGES = freezeCatalog({
  ...
  boardEditor: {
    ...
    stagesLabel: 'ステージ',
    stagesHelp: '1 行ごとに入力: stage-id | 表示名 | 遷移先-a, 遷移先-b',
