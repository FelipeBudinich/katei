const EN_MESSAGES = freezeCatalog({
  ...
  boardOptionsDialog: {
    ...
    selfRoleLabel: 'My role on this board',
    selfRoleSelectLabel: 'Board role',
    selfRoleHelp: 'Quick role changes for the active board live here. Use Portfolio to manage other boards.',
    saveSelfRole: 'Save role',
    savingSelfRole: 'Saving...',
    selfRoleSavedStatus: 'Your role on this board is now {role}.',
...
const ES_CL_MESSAGES = freezeCatalog({
  ...
  boardOptionsDialog: {
    ...
    selfRoleLabel: 'Mi rol en este tablero',
    selfRoleSelectLabel: 'Rol del tablero',
    selfRoleHelp: 'Los cambios rápidos de rol para el tablero activo viven aquí. Usa Portafolio para gestionar otros tableros.',
    saveSelfRole: 'Guardar rol',
    savingSelfRole: 'Guardando...',
    selfRoleSavedStatus: 'Tu rol en este tablero ahora es {role}.',
...
const JA_MESSAGES = freezeCatalog({
  ...
  boardOptionsDialog: {
    ...
    selfRoleLabel: 'このボードでの自分の権限',
    selfRoleSelectLabel: 'ボード権限',
    selfRoleHelp: '現在のボードの権限はここで素早く変更できます。ほかのボードはポートフォリオで管理してください。',
    saveSelfRole: '権限を保存',
    savingSelfRole: '保存しています...',
    selfRoleSavedStatus: 'このボードでの権限は現在 {role} です。',
