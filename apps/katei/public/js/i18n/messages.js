const EN_MESSAGES = freezeCatalog({
  ...
  workspace: {
    ...
    announcements: {
      ...
      cardReviewApproved: 'Card review approved.',
      cardReviewRejected: 'Card review rejected.',
  ...
  cardEditor: {
    ...
    requiresReviewLabel: 'Requires review',
    requiresReviewHelp: 'Mark this card for workflow review when it reaches a review-enabled stage.',
    workflowReview: {
...
const ES_CL_MESSAGES = freezeCatalog({
  ...
  workspace: {
    ...
    announcements: {
      ...
      cardReviewApproved: 'Revisión de la tarjeta aprobada.',
      cardReviewRejected: 'Revisión de la tarjeta rechazada.',
  ...
  cardEditor: {
    ...
    requiresReviewHelp: 'Marca esta tarjeta para revisión del flujo de trabajo cuando llegue a una etapa con revisión.',
    workflowReview: {
...
const JA_MESSAGES = freezeCatalog({
  ...
  workspace: {
    ...
    announcements: {
      ...
      cardReviewApproved: 'カードレビューを承認しました。',
      cardReviewRejected: 'カードレビューを却下しました。',
  ...
  cardEditor: {
    ...
    requiresReviewLabel: 'レビュー必須',
    requiresReviewHelp: 'レビュー対応ステージに入ったら、このカードをワークフローレビュー対象にします。',
    workflowReview: {
      statusLabel: 'レビュー状態',
      approveButton: '承認',
      rejectButton: '却下',
