...
function usage() {
  return [
    "Usage:",
    "  node /path/to/env-inventory/scripts/render-env-inventory-html.mjs --input apps/web/docs/env-inventory.json",
    "  node /path/to/env-inventory/scripts/render-env-inventory-html.mjs --input apps/web/docs/env-inventory.json --output apps/web/docs/env-inventory.html",
    "",
    "Options:",
