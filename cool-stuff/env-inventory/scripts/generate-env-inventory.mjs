...
function usage() {
  return [
    ...
    "  --app <name>        Generate one app report under the configured apps root",
    "  --all-apps          Generate all direct app children under the configured apps root",
    "  --config <path>     Optional config file (default: .agents/env-inventory.config.json)",
    "  --html              Generate/check <apps-root>/<app>/docs/env-inventory.html alongside JSON",
